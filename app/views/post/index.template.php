<div>
    ...
    <ul class="list-group flex-row pt-5 flex-wrap">
        <?php foreach ($posts as $post) { ?>
            <li class="card mx-2 my-3" style="width: 18rem;">
                <div class="card-body">
                    ...
                    <p class="card-text text-dark">Creato: <?php echo htmlentities($post["created_at"]); ?></p>
